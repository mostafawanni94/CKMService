...
# PostgreSQL recommended for production (financial data, audit trails)
...
LANGUAGE_CODE = 'nl-nl'  # Dutch (Netherlands)
...
WEEK_START_HOUR = 6  # 06:00

# File upload settings
MAX_UPLOAD_SIZE_MB = 10
ALLOWED_DOCUMENT_EXTENSIONS = ['.pdf', '.jpg', '.jpeg', '.png', '.gif']

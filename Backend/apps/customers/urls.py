...
from .views import (
    CustomerViewSet, CustomerContactViewSet, CustomerAllowanceViewSet,
    OutfolderViewSet, ServiceViewSet, GratuityViewSet, EmployeeCustomerViewSet,
)
...
router.register(r'allowances', CustomerAllowanceViewSet, basename='customer-allowance')
